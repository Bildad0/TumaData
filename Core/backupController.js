...
// Directory paths
const SOURCE_DIR = '/path/to/source/files';
const BACKUP_DIR = '/path/to/store/backups';
const RESTORE_DIR = '/path/to/restore';
...
exports.listBackups = (req, res) => {
  const query = `SELECT * FROM backups ORDER BY created_at DESC`;
